...
var w = function() {
  ...
  return a("footer", {
    ...
    style: {
      ...
      backgroundImage: "url(".concat(s.socialSprites, ")"),
    ...
    staticClass: "sr-only"
  }, [s._v("iTunes")])])])]), s._m(2)]), s._m(3), a("div", {
    staticClass: "text-sm"
  }, [s._v(" \xA9 " + s._s(s.year) + " Carnegie Mellon University ")])])])]);
}, N = [function() {
  ...
  }, [e._v("Report a Vulnerability to CERT/CC")])]), t("li", [t("a", {
    staticClass: "hover:underline focus:underline focus:outline-none",
    attrs: {
      href: "https://sei.cmu.edu/subscribe-to-sei-bulletin/"
    }
  }, [e._v("Subscribe to SEI Bulletin")])]), t("li", [t("a", {
    staticClass: "hover:underline focus:underline focus:outline-none",
    attrs: {
  ...
  var e = this, s = e.$createElement, t = e._self._c || s;
  return t("div", [t("address", {
    staticClass: "not-italic"
  }, [e._v(" Carnegie Mellon University"), t("br"), e._v(" Software Engineering Institute"), t("br"), e._v(" 4500 Fifth Avenue"), t("br"), e._v(" Pittsburgh, PA 15213-2612"), t("br"), t("a", {
  ...
  }, [e._v("Additional Sites Directory")])]), t("li", {
    staticClass: "inline-block"
  }, [e._v(" | ")]), t("li", {
    staticClass: "inline-block"
  }, [t("a", {
...
function p(e, s, t, a, b, l, o, f) {
  var n = typeof e == "function" ? e.options : e;
  s && (n.render = s, n.staticRenderFns = t, n._compiled = !0), a && (n.functional = !0), l && (n._scopeId = "data-v-" + l);
  var i;
  if (o ? (i = function(r) {
    r = r || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !r && typeof __VUE_SSR_CONTEXT__ < "u" && (r = __VUE_SSR_CONTEXT__), b && b.call(this, r), r && r._registeredComponents && r._registeredComponents.add(o);
  }, n._ssrRegister = i) : b && (i = f ? function() {
    b.call(
      this,
    ...
    if (n.functional) {
      n._injectStyles = i;
      var d = n.render;
      n.render = function(h, v) {
        return i.call(v), d(h, v);
      };
    } else {
