...
var H = function() {
  var c = this, n = c.$createElement, t = c._self._c || n;
  return t("svg", {
    attrs: {
...
function Z(l, c, n, t, r, i, e, d) {
  var s = typeof l == "function" ? l.options : l;
  c && (s.render = c, s.staticRenderFns = n, s._compiled = !0), t && (s.functional = !0), i && (s._scopeId = "data-v-" + i);
  var h;
  if (e ? (h = function(a) {
    a = a || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !a && typeof __VUE_SSR_CONTEXT__ < "u" && (a = __VUE_SSR_CONTEXT__), r && r.call(this, a), a && a._registeredComponents && a._registeredComponents.add(e);
  }, s._ssrRegister = h) : r && (h = d ? function() {
    r.call(
      this,
    ...
    if (s.functional) {
      s._injectStyles = h;
      var p = s.render;
      s.render = function(C, v) {
        return h.call(v), p(C, v);
      };
    } else {
      var o = s.beforeCreate;
      s.beforeCreate = o ? [].concat(o, h) : [h];
    }
  return {
    exports: l,
    options: s
