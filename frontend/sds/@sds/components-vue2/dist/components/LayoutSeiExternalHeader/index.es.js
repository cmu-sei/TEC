...
var H = function() {
  var s = this, r = s.$createElement, t = s._self._c || r;
  return t("svg", {
    attrs: {
...
function p(c, s, r, t, n, i, h, u) {
  var a = typeof c == "function" ? c.options : c;
  s && (a.render = s, a.staticRenderFns = r, a._compiled = !0), t && (a.functional = !0), i && (a._scopeId = "data-v-" + i);
  var l;
  if (h ? (l = function(e) {
    e = e || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext, !e && typeof __VUE_SSR_CONTEXT__ < "u" && (e = __VUE_SSR_CONTEXT__), n && n.call(this, e), e && e._registeredComponents && e._registeredComponents.add(h);
    ...
    if (a.functional) {
      a._injectStyles = l;
      var C = a.render;
      a.render = function(V, v) {
        return l.call(v), C(V, v);
      };
    } else {
      var o = a.beforeCreate;
      a.beforeCreate = o ? [].concat(o, l) : [l];
    }
  return {
    exports: c,
    options: a
...
var x = function() {
  ...
  }, [t("layout-sei-external-wordmark", {
    staticClass: "text-white fill-current h-7"
  }), t("span", {
    staticClass: "sr-only"
  }, [s._v("Carnegie Mellon University")])], 1)])]), t("div", {
  ...
  }, [s._m(0), s.page.organization ? t("h2", {
    staticClass: "text-2xl text-gray-500 break-words"
  }, [s._v(" " + s._s(s.page.organization) + " ")]) : s._e()])])])]);
}, $ = [function() {
  var c = this, s = c.$createElement, r = c._self._c || s;
  return r("h1", {
  ...
  }, [c._v("Software Engineering Institute")])]);
}];
const w = {
  name: "SdsLayoutSeiExternalHeader",
  components: {
    LayoutSeiExternalWordmark: y
  },
  props: {
    page: {
      type: Object,
