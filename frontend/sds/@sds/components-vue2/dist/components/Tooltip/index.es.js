  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        flipAlignment: h = !0,
        ...d
      } = t, m = E(i), g = u || (m === l || !h ? [j(l)] : Dt(l)), w = [l, ...g], x = await et(e, d), b = [];
...
function D(t, e, n) {
  ...
  let a = 1, c = 1;
  e && k(t) && (a = t.offsetWidth > 0 && Y(s.width) / t.offsetWidth || 1, c = t.offsetHeight > 0 && Y(s.height) / t.offsetHeight || 1);
...
function xt(t) {
  return D(z(t)).left + G(t).scrollLeft;
}
function Ut(t) {
  const e = D(t);
...
function at(t) {
  return !k(t) || F(t).position === "fixed" ? null : t.offsetParent;
}
function Xt(t) {
  let e = K(t);
  for (; k(e) && !ot(e); ) {
...
function jt(t) {
  ...
  if ((o || !o && i !== "fixed") && ((W(n) !== "body" || q(r)) && (l = G(n)), k(n))) {
    const a = D(n, !0);
...
function bt(t) {
  const e = K(t);
  return ot(e) ? t.ownerDocument.body : k(e) && q(e) ? e : bt(e);
}
function I(t, e) {
  var n;
  e === void 0 && (e = []);
...
const oe = {
  ...
  methods: {
    ...
    async update() {
      ...
      this.offset && t.middleware.push(Ft(this.offset)), e ? t.middleware.push(kt({
...
var le = function() {
  ...
  return i("floating-ui", {
    attrs: {
      ...
      "popper-class": "absolute text-xs shadow rounded-lg text-center ".concat(e.variantClass, " ").concat(e.sizeClass, " ").concat(e.zIndexClass),
      "arrow-class": "absolute w-2 h-2 rotate-45 ".concat(e.variantArrowClass),
